  	...
  	<div class="container">
  		...
  		<aside class="section-aside off-the-grid">
  			<div class="row">
	  			...
	  			<div class="section-aside-content">
	  				<div class="section-aside-content-wrapper">
			  			<p>Part of the HATCH experience is a two ￼day “OFF THE GRID” retreat / summit. The fast lane disappears and we un-plug to reconnect. No cell service. No wi-fi. Only nature and round-table Think Tanks with extraordinary peers while immersed in the refueling surroundings of Montana.</p>
			  		</div>
		  		</div>
  		</aside>
